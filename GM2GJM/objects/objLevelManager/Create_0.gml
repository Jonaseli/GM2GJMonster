...
splitString(temp1, "0, 0, 0, 0, 0, 1, 0, 0", 3);
splitString(temp1, "0, 0, 1, 0, 0, 0, 0, 0", 4);
splitString(temp1, "1, 0, 1, 0, 1, 1, 4, 1", 5);
splitString(temp1, "1, 0, 4, 0, 0, 0, 0, 1", 6);
...
splitString(temp2, "0, 1, 0, 0, 2, 0, 1, 0", 5);
splitString(temp2, "0, 1, 1, 0, 0, 1, 1, 0", 6);
...
splitString(temp3, "0, 0, 1, 0, 2, 1, 0, 0", 3);
splitString(temp3, "0, 0, 1, 0, 0, 1, 0, 0", 4);
splitString(temp3, "0, 0, 0, 0, 0, 0, 0, 0", 5);
...
splitString(temp5, "1, 4, 0, 0, 2, 0, 4, 1", 1);
splitString(temp5, "4, 0, 0, 0, 0, 0, 0, 4", 2);
splitString(temp5, "0, 0, 0, 0, 0, 2, 0, 0", 3);
splitString(temp5, "0, 2, 0, 2, 0, 0, 0, 0", 4);
splitString(temp5, "4, 0, 0, 0, 0, 0, 0, 4", 5);
splitString(temp5, "1, 4, 0, 0, 0, 0, 4, 1", 6);
